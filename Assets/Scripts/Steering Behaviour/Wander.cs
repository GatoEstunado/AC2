...
public class Wander : MonoBehaviour {
	...
	[Range(0.0f, 10.0f)]
	public float minRetargetDelay = 2;
    [Range(0.0f, 10.0f)]
    public float maxRetargetDelay = 8;
	...
	{
		// encostou em algo
		RaycastHit2D hit = Physics2D.Raycast(position, transform.right, 2, wallLayer);
	...
	void wander()  {
		...
		CancelInvoke();
		Invoke("wander", Random.Range(minRetargetDelay, maxRetargetDelay));
	}
